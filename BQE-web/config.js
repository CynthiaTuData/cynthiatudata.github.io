...
'<p>“He suddenly became ill,” said his son Earl Mukenbeck, who ran the business with elder Munkenbeck, according to the Brooklyn Daily Eagle. The son showed up at Brooklyn Supreme Court in place of his father. The court granted them until December to leave the premise.</p></div>'
...
let text_5 ='<div><img id="video" src="media/banner-vid.gif"style="filter: drop-shadow(0 0 0.1rem black);"><p>Along Hamilton Avenue, about 1,000 residents were evicted, and some 400 dwellings were razed to make way for the incoming highway.</p></div>'

let text_6 = '<p>Among the displaced were about 100 welfare tenants, police officer, baker, bar and grill owner, local metal works shop that served the waterfront for decades, and a beloved local restaurant known as the “Roast Beef King.”</p><img src="media/sanborn-map.png"/><p>Hamilton Avenue was the artery of the buzzing neighborhood of Red Hook. Since the Dutch colonists arrived at the waterfront area in South Brooklyn in the 1600s, Red Hook had been a vibrant immigrant enclave. A diverse mix of ethnic groups: Dutch, Norwegians, Italians, Puerto Ricans, and Blacks (both enslaved people brought over by the Dutch, and free blacks who fled the South)… have called Red Hook their home.</p>'+
